			...
			<CardContent>
				...
				>
					<div
						v-for="i in 5"
						:key="i"
						class="h-16 bg-muted animate-pulse rounded"
					/>
				</div>
		...
		<Dialog v-model:open="isDeleteDialogOpen">
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription> Are you sure you want to delete "{{ projectToDelete?.title }}"? This action cannot be undone. </DialogDescription>
				</DialogHeader>
				<DialogFooter>
					<Button
						variant="outline"
