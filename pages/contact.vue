    ...
    <section class="py-16 text-center">
      <div class="max-w-3xl mx-auto space-y-6">
        ...
        <p class="text-lg text-muted-foreground">
          Ready to start your next mobile project? Let's collaborate and bring your ideas to life
        </p>
      </div>
    </section>
          ...
          <Card class="p-8 border-border/50 bg-gradient-to-br from-primary/5 to-chart-1/5">
            <CardContent class="p-0">
              ...
              <p class="text-muted-foreground text-sm">
                I'm currently accepting new mobile development projects. 
        ...
        <div class="space-y-4">
          ...
          >
            <CardContent class="p-6">
              ...
              >
                <div v-if="openFaq === index" class="mt-4 text-muted-foreground">
                  {{ faq.answer }}
                </div>
              </Transition>
            </CardContent>
