      ...
      <div class="text-center space-y-8 max-w-4xl mx-auto">
        ...
        <div class="relative mx-auto w-32 h-32 mb-8">
          ...
          <div class="relative w-full h-full bg-gradient-to-r from-primary to-chart-1 rounded-full p-1">
            <div class="w-full h-full bg-background rounded-full flex items-center justify-center text-4xl font-bold text-primary">
              A
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <h1 class="text-5xl md:text-7xl font-bold leading-tight">
            <span class="bg-gradient-to-r from-foreground via-primary to-chart-1 bg-clip-text text-transparent animate-pulse">
              Muhammad Arif Amsar
            </span>
          </h1>
        ...
        <p class="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Crafting exceptional mobile experiences with Flutter, React Native, and native Android development. 
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
          ...
          >
            View My Work
            <ChevronDown class="ml-2 h-5 w-5 group-hover:translate-y-1 transition-transform" />
          </Button>
          <Button
            variant="outline"
            size="lg"
        ...
        <div class="flex justify-center space-x-6 pt-8">
          <a
            ...
            class="text-muted-foreground hover:text-primary transition-colors p-3 rounded-full hover:bg-accent"
          >
    ...
    <section id="about" class="py-20">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-muted-foreground text-lg">Passionate mobile developer with expertise in modern technologies</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-6">
            <p class="text-muted-foreground leading-relaxed">
              I'm a dedicated mobile developer with a passion for creating innovative and user-friendly applications. 
              With expertise in Flutter, React Native, and native Android development, I bring ideas to life through 
              clean, efficient code and thoughtful design.
            </p>
            <p class="text-muted-foreground leading-relaxed">
              My journey in mobile development has led me to work on diverse projects, from e-commerce platforms 
              to IoT applications, always focusing on delivering exceptional user experiences and robust functionality.
            </p>
          ...
          <div class="grid grid-cols-2 gap-6">
            <Card class="p-6 text-center hover:shadow-lg transition-shadow border-border/50">
    ...
    <section id="projects" class="py-20">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-muted-foreground text-lg">Some of my recent work and achievements</p>
        </div>
...
import { Github, Linkedin, ChevronDown, ArrowRight } from 'lucide-vue-next'
import type { Project } from '~/types'

// SEO
useSeoMeta({
  title: 'Muhammad Arif Amsar - Mobile Developer Portfolio',
  description: 'Experienced mobile developer specializing in Flutter, React Native, and Android development. View my portfolio of innovative mobile applications.',
  ogTitle: 'Muhammad Arif Amsar - Mobile Developer',
  ogDescription: 'Mobile Developer & Digital Innovator',
...
// Data
const skills = [
  'Flutter', 'React Native', 'Kotlin', 'Dart', 'TypeScript', 'Firebase', 
  'GraphQL', 'REST APIs', 'Mobile UI/UX', 'CI/CD'
]
