<template>
  <footer class="bg-card/50 border-t border-border/50 mt-20">
    <div class="container mx-auto px-4 py-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- About Section -->
        <div class="space-y-4">
          <h3 class="text-lg font-semibold text-foreground">Muhammad Arif Amsar</h3>
          <p class="text-muted-foreground text-sm">
            Mobile Developer passionate about creating innovative solutions with Flutter, React Native, and native Android development.
          </p>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2 text-sm text-muted-foreground">
            ...
            >
              Let's connect <ExternalLink class="ml-1 h-3 w-3" />
            </NuxtLink>
          </div>
        </div>
      </div>
      ...
      <div class="border-t border-border/50 mt-8 pt-8 text-center">
        <p class="text-muted-foreground text-sm">
          © {{ currentYear }} Muhammad Arif Amsar. Built with 
          <span class="text-primary">Nuxt.js</span> & 
